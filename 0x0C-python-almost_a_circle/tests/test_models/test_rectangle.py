...
class TestRectangle(unittest.TestCase):
    ...
    def test_is_Base_instance(self):
        self.assertTrue(isinstance(Rectangle(2, 5), Base), True)

    def test_rectangle_args1(self):
        a = Rectangle(1, 8)
        self.assertEqual(a.width, 1)
        self.assertEqual(a.height, 8)
        self.assertEqual(a.id, 1)

    def test_rectangle_args2(self):
        a = Rectangle(1, 8, 6, 5, None)
        self.assertEqual(a.width, 1)
        self.assertEqual(a.height, 8)
    ...
    def test_is_same(self):
        a = Rectangle(1, 2)
        b = Rectangle(1, 2)
        self.assertFalse(a is b, False)
        self.assertFalse(a.id == b.id, False)
    
    def test_more_args(self):
        with self.assertRaises(TypeError):
            Rectangle(1, 2, 2, 2, 3, 5)

class TestRectangleAttr(unittest.TestCase):

    def test_width(self):
        with self.assertRaises(AttributeError):
            Rectangle(1, 5).__width

    def test_height(self):
        with self.assertRaises(AttributeError):
            Rectangle(1, 5).__height

    def test_x(self):
        with self.assertRaises(AttributeError):
            Rectangle(2, 4, 6, 8).__x

    def test_y(self):
        with self.assertRaises(AttributeError):
            Rectangle(2, 4, 6, 8).__y
...
class TestStrMethod(unittest.TestCase):
    ...
    def test_str_method_print_width_height(self):
        ...
        self.assertEqual(r.__str__(), correct)
    ...
    def test_str_method_width_height_x_y_id(self):
        ...
        self.assertEqual("[Rectangle] (7) 2/4 - 13/21", r.__str__())
...
class TestDisplayMethod(unittest.TestCase):
    ...
    def test_display_width_height(self):
        r = Rectangle(2, 3)
        with patch('sys.stdout', new=StringIO()) as TestRectangle_stdout:
            r.display()
            self.assertEqual(TestRectangle_stdout.getvalue(), "##\n##\n##\n")
    ...
    def test_display_width_height_y(self):
        ...
        with patch('sys.stdout', new=StringIO()) as TestRectangle_stdout:
            r.display()
            self.assertEqual(TestRectangle_stdout.getvalue(), res)
...
class TestRectangleUpdateArgs(unittest.TestCase):
    ...
    def test_update_args_None_id_and_more(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(None, 4, 5, 2)
        correct = "[Rectangle] (None) 2/10 - 4/5".format(r.id)
        self.assertEqual(correct, str(r))
